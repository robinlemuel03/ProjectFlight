...
public class WebUI {
    ...
    public static void getToUrl(String URL) {
        ...
        if (ExtentTestManager.getExtentTest() != null) {
            ExtentReportManager.pass(FrameworkConstants.BOLD_START + FrameworkConstants.ICON_Navigate_Right + " Open URL : " + FrameworkConstants.BOLD_END + URL);
        }
    ...
    public static void navigateToUrl(String URL) {
        ...
        if (ExtentTestManager.getExtentTest() != null) {
            ExtentReportManager.pass(FrameworkConstants.BOLD_START + FrameworkConstants.ICON_Navigate_Right + " Navigate to URL: " + FrameworkConstants.BOLD_END + URL);
        }
